...
function loadProvincias(list, selectHtml) {
    var element = ""
    for (let i = 0; i < list.length; i++) {
        element += "<option value=" + list[i].id + ">" + list[i].nombre + "</option>"
    }
    selectHtml.innerHTML = element
}

loadProvincias(provincias, provinciasElement)
